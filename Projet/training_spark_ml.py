...
def main():
    ...
    obj: urllib3.response.HTTPResponse = minio_client.get_object(
        'capteurs' # Bucket
        'Capteurs24-04-23.csv', # Fichier CSV
    )
    ...
    '''
    assembler = VectorAssembler(inputCols=features_cols, outputCol=target_col)
    ...
    """
    lr = create_model(iter=10, features_cols="order_purchase_timestamp_int", labelCol="order_purchase_timestamp_int")
    ...
    """
    model = lr._fit(data_with_features)
